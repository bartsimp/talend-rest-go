...
// WithID adds the id to the get artifact params
func (o *GetArtifactParams) WithID(id string) *GetArtifactParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get artifact params
func (o *GetArtifactParams) SetID(id string) {
	o.ID = id
}
