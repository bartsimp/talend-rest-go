...
func (o *GetArtifactOK) Error() string {
	return fmt.Sprintf("[GET /artifacts/{id}][%d] getArtifactOK  %+v", 200, o.Payload)
}
...
func (o *GetArtifactBadRequest) Error() string {
	return fmt.Sprintf("[GET /artifacts/{id}][%d] getArtifactBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetArtifactBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetArtifactUnauthorized) Error() string {
	return fmt.Sprintf("[GET /artifacts/{id}][%d] getArtifactUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetArtifactUnauthorized) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetArtifactForbidden) Error() string {
	return fmt.Sprintf("[GET /artifacts/{id}][%d] getArtifactForbidden  %+v", 403, o.Payload)
}
...
func (o *GetArtifactForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetArtifactNotFound) Error() string {
	return fmt.Sprintf("[GET /artifacts/{id}][%d] getArtifactNotFound  %+v", 404, o.Payload)
}
...
func (o *GetArtifactNotFound) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *GetArtifactInternalServerError) Error() string {
	return fmt.Sprintf("[GET /artifacts/{id}][%d] getArtifactInternalServerError  %+v", 500, o.Payload)
}
...
func (o *GetArtifactInternalServerError) GetPayload() *models.ErrorResponse {
	return o.Payload
}
