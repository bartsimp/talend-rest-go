...
func (o *CreateProjectParams) WithBody(body *models.ProjectCreateRequest) *CreateProjectParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create project params
func (o *CreateProjectParams) SetBody(body *models.ProjectCreateRequest) {
	o.Body = body
}
