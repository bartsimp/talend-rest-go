...
func (o *StopExecutionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 204:
		result := NewStopExecutionNoContent()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func (o *StopExecutionOK) Error() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionOK  %+v", 200, o.Payload)
}
...
func (o *StopExecutionOK) GetPayload() string {
	return o.Payload
}
...
// NewStopExecutionNoContent creates a StopExecutionNoContent with default headers values
func NewStopExecutionNoContent() *StopExecutionNoContent {
	return &StopExecutionNoContent{}
}

/*
StopExecutionNoContent describes a response with status code 204, with default header values.

Execution stopped succesfully
*/
type StopExecutionNoContent struct {
}

// IsSuccess returns true when this stop execution no content response has a 2xx status code
func (o *StopExecutionNoContent) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this stop execution no content response has a 3xx status code
func (o *StopExecutionNoContent) IsRedirect() bool {
	return false
}

// IsClientError returns true when this stop execution no content response has a 4xx status code
func (o *StopExecutionNoContent) IsClientError() bool {
	return false
}

// IsServerError returns true when this stop execution no content response has a 5xx status code
func (o *StopExecutionNoContent) IsServerError() bool {
	return false
}

// IsCode returns true when this stop execution no content response a status code equal to that given
func (o *StopExecutionNoContent) IsCode(code int) bool {
	return code == 204
}

func (o *StopExecutionNoContent) Error() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionNoContent ", 204)
}

func (o *StopExecutionNoContent) String() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionNoContent ", 204)
}

func (o *StopExecutionNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *StopExecutionBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionBadRequest  %+v", 400, o.Payload)
}
...
func (o *StopExecutionBadRequest) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *StopExecutionUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionUnauthorized  %+v", 401, o.Payload)
}
...
func (o *StopExecutionUnauthorized) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *StopExecutionForbidden) Error() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionForbidden  %+v", 403, o.Payload)
}
...
func (o *StopExecutionForbidden) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *StopExecutionNotFound) Error() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionNotFound  %+v", 404, o.Payload)
}
...
func (o *StopExecutionNotFound) GetPayload() *models.ErrorResponse {
	return o.Payload
}
...
func (o *StopExecutionInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /executions/{id}][%d] stopExecutionInternalServerError  %+v", 500, o.Payload)
}
...
func (o *StopExecutionInternalServerError) GetPayload() *models.ErrorResponse {
	return o.Payload
}
