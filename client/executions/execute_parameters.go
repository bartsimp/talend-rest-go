...
func (o *ExecuteParams) WithBody(body *models.Executabletask) *ExecuteParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the execute params
func (o *ExecuteParams) SetBody(body *models.Executabletask) {
	o.Body = body
}
