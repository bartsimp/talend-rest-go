...
// WithID adds the id to the stop execution params
func (o *StopExecutionParams) WithID(id string) *StopExecutionParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the stop execution params
func (o *StopExecutionParams) SetID(id string) {
	o.ID = id
}
