...
type CreateTaskParams struct {
	...
	/* Body.
	   ...
	   Task to create
	*/
	Body *models.TaskV21CreateRequest
...
func (o *CreateTaskParams) WithBody(body *models.TaskV21CreateRequest) *CreateTaskParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create task params
func (o *CreateTaskParams) SetBody(body *models.TaskV21CreateRequest) {
	o.Body = body
}
