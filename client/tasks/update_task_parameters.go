...
type UpdateTaskParams struct {
	...
	/* Body.
	   ...
	   task
	*/
	Body *models.TaskAutoUpgradeRequest
...
func (o *UpdateTaskParams) WithBody(body *models.TaskAutoUpgradeRequest) *UpdateTaskParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update task params
func (o *UpdateTaskParams) SetBody(body *models.TaskAutoUpgradeRequest) {
	o.Body = body
}
