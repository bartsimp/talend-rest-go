...
func (o *GetResourcesParams) SetLimit(limit *int32) {
	o.Limit = limit
}

// WithName adds the name to the get resources params
func (o *GetResourcesParams) WithName(name *string) *GetResourcesParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the get resources params
func (o *GetResourcesParams) SetName(name *string) {
	o.Name = name
}
...
// SetOffset adds the offset to the get resources params
func (o *GetResourcesParams) SetOffset(offset *int32) {
	o.Offset = offset
}
