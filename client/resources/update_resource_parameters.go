...
type UpdateResourceParams struct {
	...
	/* ResourceDetail.
	   ...
	   Resource detail
	*/
	ResourceDetail *models.UpdateResourceRequest
...
// WithResourceDetail adds the resourceDetail to the update resource params
func (o *UpdateResourceParams) WithResourceDetail(resourceDetail *models.UpdateResourceRequest) *UpdateResourceParams {
	o.SetResourceDetail(resourceDetail)
	return o
}

// SetResourceDetail adds the resourceDetail to the update resource params
func (o *UpdateResourceParams) SetResourceDetail(resourceDetail *models.UpdateResourceRequest) {
	o.ResourceDetail = resourceDetail
}
...
func (o *UpdateResourceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.ResourceDetail != nil {
		if err := r.SetBodyParam(o.ResourceDetail); err != nil {
			return err
		}
	}
