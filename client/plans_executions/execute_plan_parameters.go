...
// NewExecutePlanParams creates a new ExecutePlanParams object,
...
func NewExecutePlanParams() *ExecutePlanParams {
	return &ExecutePlanParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewExecutePlanParamsWithTimeout creates a new ExecutePlanParams object
...
// NewExecutePlanParamsWithContext creates a new ExecutePlanParams object
...
// NewExecutePlanParamsWithHTTPClient creates a new ExecutePlanParams object
...
func (o *ExecutePlanParams) WithBody(body *models.PlanExecutable) *ExecutePlanParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the execute plan params
func (o *ExecutePlanParams) SetBody(body *models.PlanExecutable) {
	o.Body = body
}
